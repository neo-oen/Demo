...
@property BOOL isRequestMoreBussinessPortrait;
@end
...
- (BOOL) hasIsRequestMoreBussinessPortrait {
  return !!hasIsRequestMoreBussinessPortrait_;
}
- (void) setHasIsRequestMoreBussinessPortrait:(BOOL) value {
  hasIsRequestMoreBussinessPortrait_ = !!value;
}
- (BOOL) isRequestMoreBussinessPortrait {
  return !!isRequestMoreBussinessPortrait_;
}
- (void) setIsRequestMoreBussinessPortrait:(BOOL) value {
  isRequestMoreBussinessPortrait_ = !!value;
}
- (void) dealloc {
...
- (id) init {
  if ((self = [super init])) {
    ...
    self.isRequestMoreBussinessPortrait = NO;
  }
  return self;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasIsRequestMoreBussinessPortrait) {
    [output writeBool:3 value:self.isRequestMoreBussinessPortrait];
  }
...
- (int32_t) serializedSize {
  ...
  if (self.hasIsRequestMoreBussinessPortrait) {
    size += computeBoolSize(3, self.isRequestMoreBussinessPortrait);
  }
...
- (DownloadPortraitRequest_Builder*) mergeFrom:(DownloadPortraitRequest*) other {
  ...
  if (other.hasIsRequestMoreBussinessPortrait) {
    [self setIsRequestMoreBussinessPortrait:other.isRequestMoreBussinessPortrait];
  }
...
- (DownloadPortraitRequest_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 24: {
        [self setIsRequestMoreBussinessPortrait:[input readBool]];
        break;
      }
    }
  }
...
- (BOOL) hasIsRequestMoreBussinessPortrait {
  return result.hasIsRequestMoreBussinessPortrait;
}
- (BOOL) isRequestMoreBussinessPortrait {
  return result.isRequestMoreBussinessPortrait;
}
- (DownloadPortraitRequest_Builder*) setIsRequestMoreBussinessPortrait:(BOOL) value {
  result.hasIsRequestMoreBussinessPortrait = YES;
  result.isRequestMoreBussinessPortrait = value;
  return self;
}
- (DownloadPortraitRequest_Builder*) clearIsRequestMoreBussinessPortrait {
  result.hasIsRequestMoreBussinessPortrait = NO;
  result.isRequestMoreBussinessPortrait = NO;
  return self;
}
@end
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasPortraitSid) {
    [output writeInt32:3 value:self.portraitSid];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (int32_t) serializedSize {
  ...
  if (self.hasPortraitSid) {
    size += computeInt32Size(3, self.portraitSid);
  }
  size += self.unknownFields.serializedSize;
  memoizedSerializedSize = size;
  return size;
...
- (DownloadPortraitData_Builder*) setPortraitSid:(int32_t) value {
  result.hasPortraitSid = YES;
  result.portraitSid = value;
  return self;
}
- (DownloadPortraitData_Builder*) clearPortraitSid {
...
- (DownloadPortraitData*) businessCardPortraitsAtIndex:(int32_t) index {
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  for (DownloadPortraitData* element in self.businessCardPortraitsList) {
...
- (DownloadPortraitResponse_Builder*) replaceBusinessCardPortraitsAtIndex:(int32_t) index with:(DownloadPortraitData*) value {
  [result.mutableBusinessCardPortraitsList replaceObjectAtIndex:index withObject:value];
  return self;
}
- (DownloadPortraitResponse_Builder*) addAllBusinessCardPortraits:(NSArray*) values {
  if (result.mutableBusinessCardPortraitsList == nil) {
    result.mutableBusinessCardPortraitsList = [NSMutableArray array];
  }
...
- (DownloadPortraitResponse_Builder*) clearBusinessCardPortraitsList {
  result.mutableBusinessCardPortraitsList = nil;
  return self;
}
- (DownloadPortraitResponse_Builder*) addBusinessCardPortraits:(DownloadPortraitData*) value {
  if (result.mutableBusinessCardPortraitsList == nil) {
    result.mutableBusinessCardPortraitsList = [NSMutableArray array];
  }
