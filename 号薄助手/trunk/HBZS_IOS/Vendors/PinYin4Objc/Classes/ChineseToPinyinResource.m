...
{
    [_directory release];
    [_unicodeToHanyuPinyinTable release];
    [super dealloc];
}
...
- (void)initializeResource {
    ...
    if (dataMap) {
        self->_unicodeToHanyuPinyinTable = [[NSDictionary alloc] initWithDictionary:dataMap];
    }else{
        ...
        self->_unicodeToHanyuPinyinTable=[[NSDictionary alloc] initWithDictionary:tempMap];
