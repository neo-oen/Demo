...
static NSString *identify_url = @"_url";
static NSString *identify_index = @"_index";

@implementation HB_UrlModel
...
-(instancetype)initWithCoder:(NSCoder *)aDecoder{
    if (self = [super init]) {
        ...
        self.url = [aDecoder decodeObjectForKey:identify_url];
...
-(void)encodeWithCoder:(NSCoder *)aCoder{
    ...
    [aCoder encodeObject:self.url forKey:identify_url];
