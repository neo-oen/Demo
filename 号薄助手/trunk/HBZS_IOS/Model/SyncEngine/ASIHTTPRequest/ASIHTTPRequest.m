...
- (void)buildRequestHeaders
{
	...
	if (![[self requestHeaders] objectForKey:@"User-Agent"]) {
		...
		if (tempUserAgentString) {
         //   NSLog(@"####tempUserAgentString: %@", tempUserAgentString);
			[self addRequestHeader:@"User-Agent" value:tempUserAgentString];
		}
	}
	
   //  NSLog(@"####UserAgentString: %@", [[self requestHeaders] objectForKey:@"User-Agent"]);
...
@synthesize syncTaskType;
@synthesize protocStatus;
