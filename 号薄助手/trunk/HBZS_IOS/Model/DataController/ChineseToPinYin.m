...
+ (NSMutableArray*)stringToPinYin:(NSString *)string{
  ...
  for (int i=0; i< iLen; i++)
  {
    ...
    if (bAddStr) {
      bAddStr = NO;
      [searchArray addObject:strValue];
    }
    ...
    strValue = [NSString stringWithFormat:@"%@<[#]>%c", strRes, gb2312_string[i]];
    //vosLog(@"获得全拼[%@]", strValue);
    [searchArray addObject:strValue];
    i++;
  }
...
+ (NSString *) pinyinFromChiniseString:(NSString *)string
{
  ...
  for (int i=0; i< iLen; i++)
  {
    if ( (unsigned char)gb2312_string[i] < 0x80 )
		{
//			strValue = [strValue stringByAppendingFormat:@"%c", gb2312_string[i] > 95 ? gb2312_string[i]-32 : gb2312_string[i] ];
      [strValue appendFormat:@"%c", gb2312_string[i] > 95 ? gb2312_string[i]-32 : gb2312_string[i]];
      continue;
		}
...
//			strValue = [strValue stringByAppendingFormat:@"%c", gb2312_string[i] > 95 ? gb2312_string[i]-32 : gb2312_string[i] ];
    ...
    if ([strRes length] > 0) {
    //    strValue = [strValue stringByAppendingString:@"<[#]>"];
//      strValue = [strValue stringByAppendingString:[strRes substringToIndex:1]];
      [strValue appendString:[strRes substringToIndex:1]];
    }
    i++;
  }
