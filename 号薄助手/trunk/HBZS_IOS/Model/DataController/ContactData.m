...
+ (NSInteger)getAllContactsCount{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getAllContactsCount,addressBookRef == nil......");
        return result;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"getAllContactsCount,allContacts == nil......");
...
+ (NSMutableArray*)getAllContactMembers{
    ...
    if (addressBookRef == nil) {
        vosLog(@"getAllContactMembers,addressBookRef == nil");
        return nil;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"getAllContactMembers allContacts is nil");
        goto ERROR;
    }
...
+ (ABRecordRef)getRecordByID:(NSUInteger) recordID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getRecordByID addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == personRef){
        vosLog(@"getRecordByID personRef is nil");
...
+ (CFDataRef) getPersonImageByID:(NSUInteger) personID
{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getPersonImageByID addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == personRef){
        vosLog(@"getPersonImageByID personRef is nil");
        goto ERROR;
    }
...
+ (NSString*) getPersonNameByID:(NSUInteger) personID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getPersonNameByID addressBookRef is nil");
        goto ERROR;
    }
    ...
    if (nil == person) {
        vosLog(@"getPersonNameByID person is nil");
        goto ERROR;
    }
...
+ (NSInteger) getRecordIDByPhone:(NSString*) phoneStr{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getRecordIDByPhone addressBookRef is nil");
        return -1;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"getRecordIDByPhone allContacts is nil");
        goto ERROR;
    }
...
+ (NSString*) getRecordPhoneByID:(NSInteger) personID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getRecordPhoneByID addressBookRef is nil");
        return nil;
    }
    ...
    if (recordRef == nil) {
        vosLog(@"getRecordPhoneByID recordRef is nil");
        goto ERROR;
    }
...
+ (NSString*) getRecordEmailByID:(NSInteger) personID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getRecordEmailByID addressBookRef is nil");
        return nil;
    }
    ...
    if (recordRef == nil) {
        vosLog(@"getRecordEmailByID recordRef is nil");
        goto ERROR;
    }
...
+ (NSString*) getRecordCompnyByID:(NSInteger) personID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getRecordCompnyByID addressBookRef is nil");
        return nil;
    }
    ...
    if (recordRef == nil) {
        vosLog(@"getRecordCompnyByID recordRef is nil");
...
+ (NSMutableArray*) getAllRecordOnePhone{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getAllRecordOnePhone addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"getAllRecordOnePhone allContacts is nil");
        goto ERROR;
    }
...
+ (NSMutableArray*) getAllRecordOneEmail{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getAllRecordOneEamil addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"getAllRecordOneEamil allContacts is nil");
        goto ERROR;
    }
...
+ (BOOL) deleteContactByID:(NSInteger) personID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"deleteContactByID addressBookRef is nil");
        return NO;
    }
    ...
    if (nil == personRef){
        vosLog(@"deleteContactByID personRef is nil");
        goto ERROR;
    }
...
+ (BOOL) deleteContacts:(NSMutableArray*) mutableArray{
    ...
    if (nil == addressBookRef) {
        vosLog(@"deleteContacts addressBookRef is nil");
        return NO;
    }
    
    vosLog(@"要删除联系人个数[%d]", [mutableArray count]);
    ...
    for (NSInteger i = 0; i < [mutableArray count]; i++) {
        ...
        if (nil == personRef){
            vosLog(@"deleteContacts personRef is nil");
        ...
        //vosLog(@"已删除联系人个数[%d]/[%d]",i+1,[mutableArray count]);
    }
...
+ (BOOL) addGroupContacts:(NSInteger) groupID array:(NSMutableArray*) mutableArray{
    ...
    if (nil == addressBookRef) {
        vosLog(@"addGroupContacts addressBookRef is nil");
        return NO;
    }
    
    vosLog(@"要添加群组的联系人个数[%d]", [mutableArray count]);
    
    ABRecordRef groupRef = ABAddressBookGetGroupWithRecordID(addressBookRef, groupID);
    
    if (nil == groupRef){
        vosLog(@"addGroupContacts groupRef is nil");
        bSuccess = NO;
    ...
    for (NSInteger i = 0; i < [mutableArray count]; i++) {
        ...
        if (nil == personRef){
            vosLog(@"addGroupContacts personRef is nil");
            bSuccess = NO;
...
+ (BOOL) removeGroupContacts:(NSInteger) groupID array:(NSMutableArray*) mutableArray{
    ...
    if (nil == addressBookRef) {
        vosLog(@"removeGroupContacts addressBookRef is nil");
        return NO;
    }
    
    vosLog(@"要移出群组的联系人个数[%d]", [mutableArray count]);
    
    ABRecordRef groupRef = ABAddressBookGetGroupWithRecordID(addressBookRef, groupID);
    
    if (nil == groupRef){
        vosLog(@"removeGroupContacts groupRef is nil");
        bSuccess = NO;
    ...
    for (NSInteger i = 0; i < [mutableArray count]; i++) {
        ...
        if (nil == personRef){
            vosLog(@"removeGroupContacts personRef is nil");
            bSuccess = NO;
...
+ (NSMutableArray*) searchContactStrByNameOrPhone:(NSString*) str{
    ...
    if (nil == addressBookRef) {
        vosLog(@"searchContactStrByNameOrPhone addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"searchContactStrByNameOrPhone allContacts is nil");
        goto ERROR;
    }
...
+ (NSMutableArray*) searchContactStrByPhone:(NSString*) str{
    ...
    if (nil == addressBookRef) {
        vosLog(@"searchContactStrByPhone addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"searchContactStrByPhone allContacts is nil");
        goto ERROR;
    }
...
+ (CFArrayRef) getSearchRecordArray:(NSString*) str{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getSearchRecordArray addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"getSearchRecordArray allContacts is nil");
        goto ERROR;
    }
    ...
    for (id contact in (NSArray *) allContacts)
    {
        ...
        //    vosLog(@"[%d][%d]", range.length, range.location);
...
+ (NSMutableArray*) getSearchAllContact{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getSearchAllContact addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"getSearchAllContact allContacts is nil");
        goto ERROR;
    }
...
+ (SearchItem*) getRecordSearchItemByID:(NSInteger) personID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getRecordSearchItemByID addressBookRef is nil");
        goto ERROR;
    }
    ...
    if (nil == contact) {
        vosLog(@"getRecordSearchItemByID contact is nil");
        goto ERROR;
    }
...
+ (NSMutableArray*) getPersonAllID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getPersonAllID addressBookRef is nil");
        return nil;
    }
    ...
    if (nil == allContacts) {
        vosLog(@"getPersonAllID allContacts is nil");
        goto ERROR;
    }
...
+ (NSMutableArray*) getPersonSaveLastTime:(NSArray*) personIDArray{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getPersonSaveLastTime addressBookRef is nil");
        return nil;
    }
...
+ (NSMutableArray*) getSearchByArrayID:(NSMutableArray*) arrayID{
    ...
    if (nil == addressBookRef) {
        vosLog(@"getSearchByArrayID addressBookRef is nil");
        return nil;
    }
...
+ (BOOL)IsPhoneExistRecordContact:(NSUInteger) recordID phoneStr:(NSString*) phoneStr{
    ...
    {
        vosLog(@"IsPhoneExistRecordContact prarm error");
        return NO;
    }
    ...
    if (addressBookRef == nil) {
        vosLog(@"IsPhoneExistRecordContact addressBookRef == nil");
        goto ERROR;
    }
